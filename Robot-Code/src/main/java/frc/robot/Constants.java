...
public final class Constants {
    public static class robotConstants {                    // View is taken from rear of robot for sides
        ...
        public static final int sensor_lifter_left              = 0;
        public static final int sensor_lifter_right             = 0;
        ...
        public static final int motor_shooter_left              = 9;
        public static final int motor_shooter_right             = 10;
    }
