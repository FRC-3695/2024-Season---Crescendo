...
public final class Constants {
    public static class robotConstants {                    // View is taken from rear of robot for sides
        ...
        public static final int sensor_lifter_leftTop           = 0;
        public static final int sensor_lifter_leftBot           = 0;
        public static final int sensor_lifter_rightTop          = 0;
        public static final int sensor_lifter_rightBot          = 0;
        ...
        public static final int sensor_mainpulator_deploy       = 0;
        public static final int sensor_manupilator_retract      = 0;
